  ...
  return (
    <div className="min-h-screen bg-[#FBF7EF] text-[#1B4332] flex flex-col lg:flex-row font-sans">
      ...
      <main className="flex-1 lg:ml-64 p-4 lg:p-8 space-y-6">
        ...
        {/* Alerte Expiration / Blocage après 7j */}
        {isExpired ? (
        ...
        {/* Grille Statut & Formulaire de Règlement */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Statut Actuel & Historique (5 Cols) */}
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="p-3 rounded-2xl bg-[#FBF7EF] border border-[#E2D5C3] flex justify-between items-center">
                  ...
                  <span className={`font-black text-xs px-2.5 py-0.5 rounded-full ${
                    ...
                    {etablissement?.statut_abonnement === 'actif' ? 'Actif' : isExpired ? 'Expiré (Accès restreint)' : `Essai 7j (${daysLeft}j restants)`}
                  </span>
                </div>
          ...
          {/* Formulaire de Paiement Orange Money / MTN MoMo (7 Cols) */}
            ...
            {lastPayment && (
              <div className="p-4 rounded-2xl bg-emerald-100 border border-emerald-300 text-emerald-950 font-bold text-xs space-y-1">
                ...
                <p className="text-[11px] opacity-90">
                  Réf: {lastPayment.reference_transaction} • Montant: {lastPayment.montant.toLocaleString('fr-FR')} FCFA. Votre abonnement est actif pour 30 jours.
                </p>
              </div>
            )}
            ...
            <form onSubmit={handlePayer} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#FBF7EF] border border-[#E2D5C3] rounded-2xl p-3.5 text-sm font-bold text-[#1B4332] focus:outline-none focus:border-[#1B4332]"
                />
              </div>
